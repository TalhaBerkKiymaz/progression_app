...
?>
      ...
      <form action="./index.php?content=activate_script" method="post">
        <div class="form-group login-script">
          <h1>Activeren</h1>
          <label style="color: black;" for="inputPassword">Kies een nieuw wachtwoord:</label>
          ...
          <label style="color: black;" for="inputPasswordCheck">Type het wachtwoord opnieuw:</label>
